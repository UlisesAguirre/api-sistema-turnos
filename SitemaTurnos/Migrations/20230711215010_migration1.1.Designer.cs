...
namespace SistemaTurnos.Migrations
{
    ...
    [Migration("20230711215010_migration1.1")]
            ...
            modelBuilder.Entity("SitemaTurnos.Entities.Reservation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateReservation = new DateTime(2023, 7, 12, 18, 50, 10, 296, DateTimeKind.Local).AddTicks(8460),
                            NumOfPeople = 2,
                            ReservStatus = 1,
                            TableId = 1,
                            UserId = 1
                        ...
                        {
                            Id = 2,
                            DateReservation = new DateTime(2023, 7, 13, 18, 50, 10, 296, DateTimeKind.Local).AddTicks(8483),
                            NumOfPeople = 4,
                            ReservStatus = 1,
                            TableId = 2,
                            UserId = 2
                        ...
                        {
                            Id = 3,
                            DateReservation = new DateTime(2023, 7, 14, 18, 50, 10, 296, DateTimeKind.Local).AddTicks(8486),
                            NumOfPeople = 3,
                            ReservStatus = 1,
                            TableId = 3,
                            UserId = 3
                        ...
                        {
                            Id = 4,
                            DateReservation = new DateTime(2023, 7, 15, 18, 50, 10, 296, DateTimeKind.Local).AddTicks(8487),
                            NumOfPeople = 6,
                            ReservStatus = 1,
                            TableId = 4,
                            UserId = 4
